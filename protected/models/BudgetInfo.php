...
/**
 * This is the model class for table "tbl_budget_info".
 *
 * The followings are the available columns in table 'tbl_budget_info':
 * @property integer $id
 ...
 */
class BudgetInfo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return BudgetInfo the static model class
	 */
